...
public class ExpressionBuilder {
    ...
    public PermissionExpression build(Report report) throws IllegalAccessException {
    ...
    private void buildExpressions() throws IllegalAccessException {
        while(!operators.isEmpty()){
            ...
            switch (operator) {
                ...
                default -> throw new IllegalAccessException("Unknown operator: " + operator);
            }
